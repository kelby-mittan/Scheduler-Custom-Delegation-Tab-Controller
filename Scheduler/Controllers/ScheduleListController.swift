...
class ScheduleListController: UIViewController {
  ...
  private func showCreateEventVC(_ event: Event? = nil) { //  Event? = nil is a default parameter
    // we need to use the storyboard to get and instance of the CreateEventController
    ...
    //let createEC = CreateEventController() - creates an empty view controller without any outlets, etc, will crash if you are expecting your outlets to work if they exist in the storyboard
